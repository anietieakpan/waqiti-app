    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("API documentation for the " + applicationName + " service of P2P Finance platform")
                        .version("1.0.0")
                        .contact(new Contact()
                                .name("P2P Finance Team")
                                .email("dev@p2pfinance.com")
                                .url("https://p2pfinance.com"))
                        .license(new License()
                                .name("Proprietary")
                                .url("https://p2pfinance.com/license")))
                .servers(List.of(
                        new Server()
                                .url(serverUrl)
