/**
 * File: src/test/java/com/waqiti/notification/messaging/NotificationKafkaIntegrationTest.java
 */
...
import com.waqiti.notification.event.PaymentRequestEvent;
import com.waqiti.notification.event.UserRegisteredEvent;
import com.waqiti.notification.event.WalletTransactionEvent;
...
import com.waqiti.notification.service.NotificationSenderService;
...
public class NotificationKafkaIntegrationTest extends TestcontainersBase {
    ...
    void setUp() {
        ...
        NotificationTemplate userRegisteredTemplate = NotificationTemplate.create(
                ...
                "User Registration",
                "ACCOUNT",
                "Welcome to Waqiti, ${username}!",
                "Thank you for registering with Waqiti. Your account has been created successfully."
        );
        // Set email templates
        userRegisteredTemplate.setEmailTemplates(
                "Welcome to Waqiti!",
                "Hello ${username}, thank you for joining Waqiti!"
        );
        // Set SMS template
        userRegisteredTemplate.setSmsTemplate("Welcome to Waqiti, ${username}!");
    ...
    void userRegisteredEvent_ShouldTriggerNotification() throws Exception {
        ...
        if (!notifications.isEmpty()) {
            ...
            assertThat(notification.getTitle()).contains("Welcome to Waqiti");
